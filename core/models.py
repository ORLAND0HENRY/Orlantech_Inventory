# sales_inventory_system/core/models.py
...
class Product(models.Model):
    ...
    sku = models.CharField(max_length=50, unique=True, verbose_name="SKU/Code") # SKU/Code field
    description = models.TextField(blank=True, null=True)
...
# ... (Your existing Category and Product models above) ...
...
class SaleItem(models.Model):
    ...
    class Meta:
        # Ensures that a specific product can only appear once in a sale (unless you want to track multiple entries for same product)
        # Not strictly necessary if each SaleItem is unique, but good for data integrity.
    ...
    # You might want to update the total_amount on the Sale whenever SaleItems are added/modified
    # This can be done in a signal or overridden save method for Sale, or view logic.
    # For now, we'll keep it simple and update total_amount manually or in views.