# sales_inventory_system/core/forms.py
...
class SaleForm(forms.ModelForm):
    class Meta:
        model = Sale
        # 'sale_date' is removed from fields because it's auto_now_add=True in the model.
        # If you had a 'customer_name' field in your Sale model that you wanted users to input,
        # you would add it here, e.g., fields = ['customer_name']
